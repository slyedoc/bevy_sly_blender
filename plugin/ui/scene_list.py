...
class SCENE_UL_Bevy(bpy.types.UIList):
    bl_idname = "SCENE_UL_bevy"
...
class SCENES_LIST_OT_actions(Operator):
    ...
    def invoke(self, context, event):
        ...
        target = getattr(bevy, target_name)
        idx = getattr(bevy, target_index)
        current_index = getattr(bevy, target_index)
        ...
        try:
            ...
            if self.action == 'DOWN' and idx < len(target) - 1:
                ...
                setattr(bevy, target_index, current_index +1 )
        ...
        if self.action == 'ADD':
            ...
            if new_scene_name:
                ...
                setattr(bevy, target_index, len(target) - 1)
