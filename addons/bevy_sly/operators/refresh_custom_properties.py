...
class COMPONENTS_OT_REFRESH_CUSTOM_PROPERTIES_ALL(Operator):
    ...
    def execute(self, context):
        ...
        for index, object in enumerate(bpy.data.objects):
            bevy.apply_propertyGroup_values_to_object_customProperties(object)
...
class COMPONENTS_OT_REFRESH_PROPGROUPS_FROM_CUSTOM_PROPERTIES_CURRENT(Operator):
    ...
    def execute(self, context):
        ...
        error = False
        try:
            bevy.apply_customProperty_values_to_object_propertyGroups(object)
            progress = 0.5
...
class COMPONENTS_OT_REFRESH_PROPGROUPS_FROM_CUSTOM_PROPERTIES_ALL(Operator):
    ...
    def execute(self, context):
        ...
        bevy = context.window_manager.bevy # type: BevySettings
        bevy.disable_all_object_updates = True
        ...
        bevy.disable_all_object_updates = False
